...
The consolidated roads are available from the B.C. Data Catalogue (https://catalogue.data.gov.bc.ca/dataset/ce-roads-2021). They are based on the British Columbia [Digital Road Atlas available from the B.C. Data
...
include generating a distance to road surface with an assigned a decay value
based on road type.
